                            ...
                            <div class="border border-gray-200 p-4 rounded-lg space-y-4 dark:border-gray-700">
                                ...
                                <div class="grid grid-cols-3 sm:grid-cols-5 gap-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-800 dark:text-gray-200">{{ '$ ' . $institute->price }}</p>
                                    </div>
                                    <div>
                            ...
                            <div class="w-full max-w-2xl sm:text-right space-y-2">
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
                                    <dl class="grid sm:grid-cols-5 gap-x-3">
                                        ...
                                        <dd class="col-span-2 text-gray-500">{{ '$ ' . $invoice->totalAmount }}</dd>
                                    </dl>
                                    ...
                                    <dl class="grid sm:grid-cols-5 gap-x-3">
                                        ...
                                        <dd class="col-span-2 text-gray-500">-</dd>
                                    </dl>
                                    ...
                                    <dl class="grid sm:grid-cols-5 gap-x-3">
                                        <dt class="col-span-3 font-semibold text-gray-800 dark:text-gray-200">Due
                                            balance:</dt>
                                        <dd
                                            class="col-span-2 {{ $invoice->outstandingAmount > 0 ? 'text-red-500' : 'text-green-500' }} ">
                                            {{ '$ ' . $invoice->outstandingAmount }}</dd>
                                    </dl>
                                </div>
                                <!-- End Grid -->
                            </div>
    ...
    <div id="payInvoice"
        ...
        <div
            ...
            <div class="relative flex flex-col bg-white shadow-lg rounded-xl dark:bg-gray-950">
                ...
                <form id="pay_invoice" method="POST" action="{{ route('pay') }}" accept-charset="UTF-8"
