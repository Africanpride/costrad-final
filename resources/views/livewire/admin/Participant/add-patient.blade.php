<x-admin.participant-modal formAction="addParticipant">
    <x-slot name="title">
    ...
    <x-slot name="content">
        ...
        <div class=" w-full text-sm dark:text-white space-y-3 ">
            ...
            <div class="grid space-y-3">
                <div class="relative flex items-start">
                    <div class="flex items-center h-5">
                        <input id="hs-checkbox-delete" name="hs-checkbox-delete" type="checkbox" wire:model='insured'
                ...
                <div class="relative flex items-start">
                    <div class="flex items-center h-5">
                        <input id="hs-checkbox-archive" name="hs-checkbox-archive" type="checkbox" wire:model='active'
                            class="border-gray-200 rounded text-blue-600 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
            ...
            <div>
                <div class="relative">
                    <x-jet-input wire:model="email" type="text" placeholder="Participant email Address"
