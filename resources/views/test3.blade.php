<x-front-layout>
    <div class="fixed right-0 bottom-0 m-6 p-2 bg-white inline-flex items-center rounded-full z-10">
        <button class="bg-gray-700 w-4 h-4 rounded-full mr-2 outline-none focus:outline-none"
        ...
        <button class="bg-yellow-700 w-4 h-4 rounded-full mr-2 outline-none focus:outline-none"
            theme-button="yellow"></button>
        <button class="bg-green-700 w-4 h-4 rounded-full mr-2 outline-none focus:outline-none"
            theme-button="green"></button>
        <button class="bg-teal-700 w-4 h-4 rounded-full mr-2 outline-none focus:outline-none"
            theme-button="teal"></button>
        <button class="bg-blue-700 w-4 h-4 rounded-full mr-2 outline-none focus:outline-none"
            theme-button="blue"></button>
        <button class="bg-indigo-700 w-4 h-4 rounded-full mr-2 outline-none focus:outline-none"
            theme-button="indigo"></button>
        <button class="bg-purple-700 w-4 h-4 rounded-full mr-2 outline-none focus:outline-none"
    ...
    <div class="flex flex-col min-h-screen">
        <div class="bg-firefly-900">
            <div class="p-5 border-b border-gray-700 flex items-center justify-between">
                <button
                    class="border border-gray-600 text-gray-600 px-4 py-2 rounded-full inline-flex items-center hover:bg-gray-600 hover:text-white">
                ...
                <svg class="w-10 h-10" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="20" cy="20" r="16" stroke="#FFF" stroke-width="8" fill="none"
                        fill-rule="evenodd" />
                </svg>
                <div class="inline-flex items-center text-gray-600">
                    <svg class="w-5 h-5 fill-current mr-4" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="sm:pl-10 sm:pt-4 flex-1">
                        <div class="flex sm:justify-between sm:flex-row sm:flex-no-wrap justify-center flex-wrap mb-6">
                            <div class="flex flex-wrap md:w-auto w-full md:mb-0 mb-4">
                                <h2 class="text-white text-2xl w-full mb-3 text-center sm:text-left mt-4 sm:mt-0">{{ Auth::user()->full_name}}</h2>
                                <div class="flex sm:w-auto w-full sm:justify-start justify-center">
                                    <span class="text-gray-600 mr-4 tracking-wider"><span
                                            class="text-gray-400">120</span> Followers</span>
                                    <span class="text-gray-600 mr-4 tracking-wider"><span
                                            class="text-gray-400">45</span> Following</span>
                                </div>
                                <div
                                    class="flex sm:w-auto sm:mt-0 mt-4 sm:mb-0 mb-2 w-full sm:justify-start justify-center">
                        ...
                        <p class="text-gray-500 leading-normal px-4 sm:px-0">
                            Businesses often become known today through effective marketing. The marketing may be in the
                            form of a regular news item or half column society news in the Sunday newspaper. The
        ...
        <div class="bg-gray-900 pt-12 pb-6 flex-1">
            <div class="container mx-auto">
                <div class="flex flex-wrap md:-mx-3">
                    ...
                    <div class="md:w-1/2 px-3 mb-6 w-full">
                        <div class="flex w-full h-full flex-wrap bg-firefly-900 overflow-hidden rounded">
                            <div class="w-2/6">
                            ...
                            <div class="w-4/6 p-5">
                                <h2 class="text-white leading-normal text-lg">How To Boost Your Traffic Of Your Blog
                                    And Destroy The Competition</h2>
