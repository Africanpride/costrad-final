<x-app-layout>
    <x-admin.pageheader model-name="Institutes " description="COSTrAD & Institutes" add-button="false" class="mx-4">
        ...
        <div class="flex justify-between items-center gap-x-4 px-4">
            <x-jet-button class="" type="button"
                onclick="Livewire.emit('openModal', 'admin.institute.add-institute')">
