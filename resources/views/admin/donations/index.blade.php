<x-app-layout>
    <x-admin.pageheader model-name="Donations " description="COSTrAD Donations" add-button="false" class="mx-4">
        <x-heroicon-o-user-group class="w-5 h-5 text-current" />
        </x-admin-pageheader>

        <section class="relative">
            <p class="text-lg font-normal text-gray-500 lg:text-xl  dark:text-gray-200 px-6">{{  __('Global Donations List') }}</p>
            <!-- Jumbotron -->
                                            ...
                                            <td class="py-2  whitespace-no-wrap text-[12px] leading-5 ">
                                                <div class="grid grid-cols-1 gap-1">
                                                    ...
                                                    <div
                                                        ...
                                                        <span
                                                            class="capitalize">{{ $donation->donor_email }}</span>
                                                    </div>
                                                </div>
                                            </td>
