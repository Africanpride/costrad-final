    ...
    {!! $institute->name !!}" add-button="false" class="mx-2">
        ...
        <section class="max-w-8xl p-4 md:p-8   mx-auto">
            ...
            <div class=" space-y-4 pb-12 m-8 p-5 border border-gray-300/80 dark:border-gray-800/80 rounded-xl ">
                ...
                <form method="POST" action="{{ route('transactions.update', [$institute->slug]) }}" id=""
                            ...
                            <div
                                ...
                                <div class="flex items-start py-2 relative">
                                    <div class="flex items-center h-5">
                                        <input id="hs-checkbox-archive" name="active" type="checkbox" name='active'
                                    ...
                                    <label for="hs-checkbox-archive" class="ml-3">
                                        <span class="block text-sm font-semibold text-gray-800 dark:text-white">Allow
                                ...
                                <div>
                                    <div>
                                        ...
                                        <x-jet-input name="startDate" id="startDate" type="text"
                                            value="{!! $institute->startDate !!}" class="mt-1 block w-full dark:text-white"
                                ...
                                <div>
                                    <div>
                                        ...
                                        <x-jet-input name="endDate" id="endDate" type="text"
                                            value="{!! $institute->endDate !!}" class="mt-1 block w-full dark:text-white"
