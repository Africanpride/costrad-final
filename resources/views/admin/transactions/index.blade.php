<x-app-layout>
    <x-admin.pageheader model-name="Transactions " description="Transaction Details" add-button="false" class="mx-4">
        <x-heroicon-o-user-group class="w-5 h-5 text-current" />
        </x-admin-pageheader>


        <section class="relative">
            <p class="text-lg font-normal text-gray-500 lg:text-xl  dark:text-gray-200 px-6">Transaction List for all
                Institutes</p>
            <!-- Jumbotron -->
            <div class="p-6 shadow  bg-gray-100 dark:bg-slate-900/10 dark:text-white ">
                ...
                <div class=" border dark:border-0 overflow-hidden ">
                    <div class="overflow-x-auto">
                                            ...
                                            <td
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ml-3">
                                                        ...
                                                        <div
                                                            class="text-sm capitalize leading-5 font-medium whitespace-nowrap">
                                                            {{ $transaction->institute->duration }},
                                                            {{ now()->format('Y') }}
                                                        </div>
                                            ...
                                            <td class="py-2  whitespace-no-wrap text-[12px] leading-5 ">
                                                <div class="grid grid-cols-1 gap-1">
                                                    ...
                                                    <div
                                                        ...
                                                        <span
                                                            class="capitalize">{{ $transaction->participant->email }}</span>
                        ...
                        <div
                            class=" px-3  py-3 sm:px-6 border-t border-secondary-200 rounded-b-md bg-white dark:bg-secondary-800 dark:border-secondary-900">
                            <div>
                                {{ $transactions->links() }}
